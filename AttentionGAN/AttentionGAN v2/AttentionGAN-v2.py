...
if opt.epoch != 0:
    ...
    netG_A2B.load_state_dict(torch.load("ar_neutral2happiness/netG_A2B.pth"))
    netG_B2A.load_state_dict(torch.load("ar_neutral2happiness/netG_B2A.pth"))
    netD_A.load_state_dict(torch.load("ar_neutral2happiness/netD_A.pth"))
    netD_B.load_state_dict(torch.load("ar_neutral2happiness/netD_B.pth"))
else:
    # Initialize weights
